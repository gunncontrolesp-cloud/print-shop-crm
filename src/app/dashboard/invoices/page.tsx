          ...
          <div className="flex flex-col items-center py-20 text-center">
            ...
            {!ql && (
              <Link
                ...
                className="flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-foreground bg-card border border-border rounded-lg hover:bg-muted/60 transition-colors"
              >
