  ...
  return (
    <div className="p-4 sm:p-8 max-w-xl">
      ...
      <div className="flex items-center gap-3 mb-2">
        <h1 className="text-2xl font-semibold text-foreground">Accounting Integration</h1>
      ...
      <form action={saveAccountingSettings} className="space-y-5">
        ...
        <div className="flex items-center gap-3">
          ...
          />
          <label htmlFor="accounting_webhook_enabled" className="text-sm text-foreground cursor-pointer">
      ...
      <div className="mt-6 pt-6 border-t border-border/50">
        <p className="text-sm font-medium text-foreground mb-3">Test Connection</p>
      ...
      <div className="mt-6 pt-6 border-t border-border/50">
        <p className="text-sm font-medium text-foreground mb-2">Events fired</p>
        <ul className="text-xs text-muted-foreground space-y-1">
          <li>
            <code className="font-mono text-foreground">invoice.created</code> — when an invoice is
            generated from an order
          </li>
          <li>
            <code className="font-mono text-foreground">invoice.paid</code> — when Stripe confirms
            payment
          </li>
        </ul>
        <p className="text-xs text-muted-foreground mt-2">
